...
class Product(Base):
    ...
    cost = Column(Numeric)
    Orders = relationship(
        "Order", secondary=links_products_orders, cascade="all, delete"
    )
    Categories = relationship(
        "Category", secondary=links_products_categories, cascade="all, delete"
    )
    ...
    def __init__(
        self, name: str, brand: str, manufacturer: str, manufacture_date: str, cost: int
    ):
        self.name = name
        self.brand = brand
